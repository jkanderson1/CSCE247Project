...
class childCollectionTest{
    private ChildCollection childcollection = ChildCollection.getChild();
    private static ArrayList<Child> children = ChildCollection.getChild(0, 0);
